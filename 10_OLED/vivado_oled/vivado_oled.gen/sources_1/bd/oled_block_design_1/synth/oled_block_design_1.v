...
//Command     : generate_target oled_block_design_1.bd
//Design      : oled_block_design_1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "oled_block_design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=oled_block_design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "oled_block_design_1.hwdef" *) 
module oled_block_design_1
   (clk,
    oled_dc_n,
    oled_reset_n,
    oled_spi_clk,
  ...
  oled_block_design_1_clk_wiz_0 clk_wiz
       (.clk_in1(clk_1),
        .clk_out1(clk_wiz_clk_out1),
        .locked(clk_wiz_locked),
        .reset(rst_1));
  oled_block_design_1_top_0_0 top_0
       (.clk(clk_wiz_clk_out1),
        ...
        .switches(switches_1));
  oled_block_design_1_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(clk_wiz_locked),
