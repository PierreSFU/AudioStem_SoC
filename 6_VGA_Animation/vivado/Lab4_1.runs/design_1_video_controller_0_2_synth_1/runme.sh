...
HD_PWD='C:/Users/pdrego/Downloads/Final_Project/6_VGA_Animation/vivado/Lab4_1.runs/design_1_video_controller_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_video_controller_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_video_controller_0_2.tcl
