...
#
# Generated by export_simulation on Thu Apr 14 13:23:27 -0700 2022
#
################################################################################
...
'-reset_run' switch to the './DMA_block_design.sh' script.

./DMA_block_design.sh -reset_run
...
./DMA_block_design.sh -noclean_files

For more information on the script, please type './DMA_block_design.sh -help'.
