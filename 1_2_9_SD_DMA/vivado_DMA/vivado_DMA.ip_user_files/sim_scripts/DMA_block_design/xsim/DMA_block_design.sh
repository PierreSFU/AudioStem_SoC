...
xv_boost_lib_path=C:/School/Xilinix_Vivado/Vivado/2020.2/tps/boost_1_64_0
...
{
  file="xsim.ini"
  lib_map_path="C:/School/Xilinix_Vivado/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DMA_block_design.wdb xsim.dir)
