...
proc create_root_design { parentCell } {
  ...
  set oled_dc_n [ create_bd_port -dir O oled_dc_n ]
  set oled_reset_n [ create_bd_port -dir O oled_reset_n ]
  set oled_spi_clk [ create_bd_port -dir O oled_spi_clk ]
  set oled_spi_data [ create_bd_port -dir O oled_spi_data ]
  ...
  set VGA_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:design_1_wrapper:1.0 VGA_0 ]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {148500000} \
 ] [get_bd_pins /VGA_0/sys_clock]
  ...
  # Create instance: clk_wiz_OLED, and set properties
  set clk_wiz_OLED [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_OLED ]
  set_property -dict [ list \
   CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $clk_wiz_OLED

  # Create instance: clk_wiz_VGA, and set properties
  set clk_wiz_VGA [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_VGA ]
  set_property -dict [ list \
  ...
  # Create instance: util_vector_logic_OLED, and set properties
  set util_vector_logic_OLED [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 util_vector_logic_OLED ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {not} \
   CONFIG.C_SIZE {1} \
   CONFIG.LOGO_FILE {data/sym_notgate.png} \
 ] $util_vector_logic_OLED
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_net -net OLED_0_oled_dc_n [get_bd_ports oled_dc_n] [get_bd_pins OLED_0/oled_dc_n]
  connect_bd_net -net OLED_0_oled_reset_n [get_bd_ports oled_reset_n] [get_bd_pins OLED_0/oled_reset_n]
  connect_bd_net -net OLED_0_oled_spi_clk [get_bd_ports oled_spi_clk] [get_bd_pins OLED_0/oled_spi_clk]
  connect_bd_net -net OLED_0_oled_spi_data [get_bd_ports oled_spi_data] [get_bd_pins OLED_0/oled_spi_data]
  connect_bd_net -net OLED_0_oled_vbat [get_bd_ports oled_vbat] [get_bd_pins OLED_0/oled_vbat]
  connect_bd_net -net OLED_0_oled_vdd [get_bd_ports oled_vdd] [get_bd_pins OLED_0/oled_vdd]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins OLED_0/clk] [get_bd_pins clk_wiz_OLED/clk_out1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_OLED/locked] [get_bd_pins util_vector_logic_OLED/Op1]
  connect_bd_net -net clk_wiz_VGA_locked [get_bd_pins VGA_0/rst] [get_bd_pins clk_wiz_VGA/locked]
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins VGA_0/sys_clock] [get_bd_pins clk_wiz_VGA/clk_out1]
  connect_bd_net -net design_1_wrapper_0_h_sync [get_bd_ports h_sync] [get_bd_pins VGA_0/h_sync]
  connect_bd_net -net design_1_wrapper_0_v_sync [get_bd_ports v_sync] [get_bd_pins VGA_0/v_sync]
  connect_bd_net -net design_1_wrapper_0_vga_b [get_bd_ports vga_b] [get_bd_pins VGA_0/vga_b]
  connect_bd_net -net design_1_wrapper_0_vga_g [get_bd_ports vga_g] [get_bd_pins VGA_0/vga_g]
  connect_bd_net -net design_1_wrapper_0_vga_r [get_bd_ports vga_r] [get_bd_pins VGA_0/vga_r]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins clk_wiz_OLED/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins clk_wiz_VGA/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net switches_1 [get_bd_ports switches] [get_bd_pins OLED_0/switches] [get_bd_pins VGA_0/switches]
  connect_bd_net -net util_vector_logic_OLED_Res [get_bd_pins OLED_0/rst] [get_bd_pins util_vector_logic_OLED/Res]
  connect_bd_net -net util_vector_logic_RESET_Res [get_bd_pins clk_wiz_OLED/reset] [get_bd_pins clk_wiz_VGA/reset] [get_bd_pins rst_ps7_0_100M/peripheral_reset]
