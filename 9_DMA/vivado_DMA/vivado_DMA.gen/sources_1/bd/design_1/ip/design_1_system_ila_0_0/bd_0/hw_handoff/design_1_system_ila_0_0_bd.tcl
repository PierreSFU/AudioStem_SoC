...
proc create_root_design { parentCell } {
  ...
  # Create instance: slot_4_apc, and set properties
  set slot_4_apc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_protocol_checker:2.0 slot_4_apc ]
  set_property -dict [ list \
   ...
   CONFIG.MAX_CONTINUOUS_RTRANSFERS_WAITS {0} \
   CONFIG.MAX_CONTINUOUS_WTRANSFERS_WAITS {0} \
   CONFIG.MAX_RD_BURSTS {2} \
   CONFIG.MAX_R_WAITS {0} \
   CONFIG.MAX_WLAST_TO_AWVALID_WAITS {0} \
   CONFIG.MAX_WRITE_TO_BVALID_WAITS {0} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets Conn4] [get_bd_intf_ports SLOT_4_AXI] [get_bd_intf_pins slot_4_apc/PC_AXI]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins g_inst/aclk] [get_bd_pins ila_lib/clk] [get_bd_pins slot_4_apc/aclk]
  ...
  connect_bd_net -net net_slot_2_axis_tkeep [get_bd_pins g_inst/m_slot_2_axis_tkeep] [get_bd_pins ila_lib/probe46]
  connect_bd_net -net net_slot_2_axis_tlast [get_bd_pins g_inst/m_slot_2_axis_tlast] [get_bd_pins ila_lib/probe49]
  connect_bd_net -net net_slot_2_axis_tready [get_bd_pins g_inst/m_slot_2_axis_tready] [get_bd_pins ila_lib/probe48]
  connect_bd_net -net net_slot_2_axis_tvalid [get_bd_pins g_inst/m_slot_2_axis_tvalid] [get_bd_pins ila_lib/probe47]
  connect_bd_net -net net_slot_3_axis_tdata [get_bd_pins g_inst/m_slot_3_axis_tdata] [get_bd_pins ila_lib/probe50]
  connect_bd_net -net net_slot_3_axis_tkeep [get_bd_pins g_inst/m_slot_3_axis_tkeep] [get_bd_pins ila_lib/probe51]
  connect_bd_net -net net_slot_3_axis_tlast [get_bd_pins g_inst/m_slot_3_axis_tlast] [get_bd_pins ila_lib/probe54]
  connect_bd_net -net net_slot_3_axis_tready [get_bd_pins g_inst/m_slot_3_axis_tready] [get_bd_pins ila_lib/probe53]
  connect_bd_net -net net_slot_3_axis_tvalid [get_bd_pins g_inst/m_slot_3_axis_tvalid] [get_bd_pins ila_lib/probe52]
  connect_bd_net -net net_slot_4_apc_pc_asserted [get_bd_pins ila_lib/probe87] [get_bd_pins slot_4_apc/pc_asserted]
  connect_bd_net -net net_slot_4_apc_pc_status [get_bd_pins ila_lib/probe88] [get_bd_pins slot_4_apc/pc_status]
  connect_bd_net -net net_slot_4_axi_ar_cnt [get_bd_pins g_inst/m_slot_4_axi_ar_cnt] [get_bd_pins ila_lib/probe55]
  connect_bd_net -net net_slot_4_axi_ar_ctrl [get_bd_pins ila_lib/probe85] [get_bd_pins slot_4_ar/dout]
  connect_bd_net -net net_slot_4_axi_araddr [get_bd_pins g_inst/m_slot_4_axi_araddr] [get_bd_pins ila_lib/probe56]
  connect_bd_net -net net_slot_4_axi_arburst [get_bd_pins g_inst/m_slot_4_axi_arburst] [get_bd_pins ila_lib/probe57]
  connect_bd_net -net net_slot_4_axi_arcache [get_bd_pins g_inst/m_slot_4_axi_arcache] [get_bd_pins ila_lib/probe58]
  connect_bd_net -net net_slot_4_axi_arlen [get_bd_pins g_inst/m_slot_4_axi_arlen] [get_bd_pins ila_lib/probe59]
  connect_bd_net -net net_slot_4_axi_arlock [get_bd_pins g_inst/m_slot_4_axi_arlock] [get_bd_pins ila_lib/probe60]
  connect_bd_net -net net_slot_4_axi_arprot [get_bd_pins g_inst/m_slot_4_axi_arprot] [get_bd_pins ila_lib/probe61]
  connect_bd_net -net net_slot_4_axi_arqos [get_bd_pins g_inst/m_slot_4_axi_arqos] [get_bd_pins ila_lib/probe62]
  connect_bd_net -net net_slot_4_axi_arready [get_bd_pins g_inst/m_slot_4_axi_arready] [get_bd_pins slot_4_ar/In1]
  connect_bd_net -net net_slot_4_axi_arregion [get_bd_pins g_inst/m_slot_4_axi_arregion] [get_bd_pins ila_lib/probe63]
  connect_bd_net -net net_slot_4_axi_arsize [get_bd_pins g_inst/m_slot_4_axi_arsize] [get_bd_pins ila_lib/probe64]
  connect_bd_net -net net_slot_4_axi_arvalid [get_bd_pins g_inst/m_slot_4_axi_arvalid] [get_bd_pins slot_4_ar/In0]
  connect_bd_net -net net_slot_4_axi_aw_cnt [get_bd_pins g_inst/m_slot_4_axi_aw_cnt] [get_bd_pins ila_lib/probe65]
  connect_bd_net -net net_slot_4_axi_aw_ctrl [get_bd_pins ila_lib/probe82] [get_bd_pins slot_4_aw/dout]
  connect_bd_net -net net_slot_4_axi_awaddr [get_bd_pins g_inst/m_slot_4_axi_awaddr] [get_bd_pins ila_lib/probe66]
  connect_bd_net -net net_slot_4_axi_awburst [get_bd_pins g_inst/m_slot_4_axi_awburst] [get_bd_pins ila_lib/probe67]
  connect_bd_net -net net_slot_4_axi_awcache [get_bd_pins g_inst/m_slot_4_axi_awcache] [get_bd_pins ila_lib/probe68]
  connect_bd_net -net net_slot_4_axi_awlen [get_bd_pins g_inst/m_slot_4_axi_awlen] [get_bd_pins ila_lib/probe69]
  connect_bd_net -net net_slot_4_axi_awlock [get_bd_pins g_inst/m_slot_4_axi_awlock] [get_bd_pins ila_lib/probe70]
  connect_bd_net -net net_slot_4_axi_awprot [get_bd_pins g_inst/m_slot_4_axi_awprot] [get_bd_pins ila_lib/probe71]
  connect_bd_net -net net_slot_4_axi_awqos [get_bd_pins g_inst/m_slot_4_axi_awqos] [get_bd_pins ila_lib/probe72]
  connect_bd_net -net net_slot_4_axi_awready [get_bd_pins g_inst/m_slot_4_axi_awready] [get_bd_pins slot_4_aw/In1]
  connect_bd_net -net net_slot_4_axi_awregion [get_bd_pins g_inst/m_slot_4_axi_awregion] [get_bd_pins ila_lib/probe73]
  ...
  connect_bd_net -net net_slot_4_axi_b_ctrl [get_bd_pins ila_lib/probe84] [get_bd_pins slot_4_b/dout]
  ...
  connect_bd_net -net net_slot_4_axi_r_ctrl [get_bd_pins ila_lib/probe86] [get_bd_pins slot_4_r/dout]
  ...
  connect_bd_net -net net_slot_4_axi_rresp [get_bd_pins g_inst/m_slot_4_axi_rresp] [get_bd_pins ila_lib/probe79]
  connect_bd_net -net net_slot_4_axi_rvalid [get_bd_pins g_inst/m_slot_4_axi_rvalid] [get_bd_pins slot_4_r/In0]
  connect_bd_net -net net_slot_4_axi_w_ctrl [get_bd_pins ila_lib/probe83] [get_bd_pins slot_4_w/dout]
  connect_bd_net -net net_slot_4_axi_wdata [get_bd_pins g_inst/m_slot_4_axi_wdata] [get_bd_pins ila_lib/probe80]
  ...
  connect_bd_net -net net_slot_4_axi_wstrb [get_bd_pins g_inst/m_slot_4_axi_wstrb] [get_bd_pins ila_lib/probe81]
  connect_bd_net -net net_slot_4_axi_wvalid [get_bd_pins g_inst/m_slot_4_axi_wvalid] [get_bd_pins slot_4_w/In0]
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins g_inst/aresetn] [get_bd_pins slot_4_apc/aresetn]
